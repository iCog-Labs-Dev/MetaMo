...
- [x] Add the constitutional mode set: `Engaged`, `Threat`, `Rumination`, and `Sleep` for the MVP.
  - [ ] Add the preemption order: Threat-remediation > Recovery > Interactive > Orienting > Engaged > Rumination > Sleep.
  - [ ] Consume existing signals rather than introducing a parallel salience substrate.
